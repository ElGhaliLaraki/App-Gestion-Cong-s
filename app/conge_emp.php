<?php 
	$sql = "SELECT * FROM conge WHERE num = '{$_SESSION['id']}' ORDER BY numero DESC";
...
<?php
	while($data = $query->fetch_object())
	{
		echo "<tr>";
			...
			echo "<td><a href=\"index.php?page=conge_emp_sup&numero={$data->numero}\"class=\"btn btn-default btn-sm\"><i class=\"fa fa-trash\"></i></a></td>";
		echo "</tr>";
	}
?>
											</tbody>
